...
router.get('/login', async function(req, res){
    ...
    const redirect_uri = 'https://social-engineer.heroku.com/';
    const login_url =  'https://api.instagram.com/oauth/authorize/?client_id=' + client_id + '&redirect_uri=https://social-engineer.heroku.com/' + '&response_type=code';
